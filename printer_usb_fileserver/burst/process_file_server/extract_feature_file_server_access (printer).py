...
##############################################
######file server to printer  extract#########
##############################################
...
for path, folder, files in walk(printer_path):
    for file_name in files:
        list_train_printer.append(file_name)

#printer data and file server data intersection file name#
